<!-- Modal -->
<div class="modal fade" id="exampleModal{{$ls->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form action="{{ route('agendamento.destroy' , $ls->id ) }}"  method="POST">
            @csrf
            @method('DELETE')
